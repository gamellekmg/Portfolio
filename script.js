...
const translations = {
  en: {
    ...
    "about.p1": "I’m a problem solver who works with both logic and heart. I love creating things that not only work well but also help people in real life. As a bilingual student (English and French) in software engineering, I have learned to stay calm and organized even when life gets busy. During my last term, I managed a part-time internship, my university classes, and tutoring high school students at the same time. It taught me how to plan, focus, and support others all while keeping a positive attitude. I also started a small personal project to help local small businesses build their websites and grow online. For me, it was more than a coding project it was a way to make technology useful for people who really need it. It also gave me a great chance to practice and improve my development skills while helping others.",
    "about.p2": "I believe that technology should be human, and that empathy, kindness, and good communication make a real difference in any team. I’m someone who likes to laugh, share ideas, and always bring good energy to my work. If you’re looking for someone who can code carefully and care deeply, I’d love to work with you.",
    ...
    "projects.cepap.desc": "Here's my first ongoing project under AG Code & Design for an educational organization. An educational dashboard to organize and share teaching materials. File upload/download, category sorting, and user sign-in are already functional. Upcoming features include an admin dashboard to view event registrations, an event list for teachers, and support for uploading presentation videos.",
